                    ...
                    <div className="w-full flex flex-col items-center-safe h-full">
                        <div className="flex flex-col lg:flex-row md:items-start lg:items-center justify-center w-full xl:max-w-full gap-6 md:gap-4 lg:gap-8">
                            <div className="flex flex-col md:flex-row lg:flex-col w-full h-full md:pt-4 lg:py-0 items-center md:items-start lg:w-full lg:max-w-[400px] gap-6 md:gap-4 lg:gap-8">
                                <div className={`flex flex-col bg-white w-full flex-1 max-w-[400px] lg:h-[558px] lg:max-h-[900px] lg:min-w-[200px] flex-wrap lg:max-w-[400px] px-6 py-4 lg:p-6 gap:3 md:gap-3 lg:gap-4 rounded-3xl border-b-4 border-r-4 border-t-[1px] border-l-[1px]`}>
                                    <h1 className="w-full text-center text-base xl:text-xl font-['Angkor'] text-[#CC9614]">Total stats</h1>
                                    <ol className={`flex flex-col ${isExpanded ? 'max-h-[391px]' : 'max-h-[144px]'} md:max-h-full overflow-clip gap-3 xl:gap-4 text-base xl:text-xl font-medium`}>
                                        <li className="flex items-center flex-row gap-3">
                                            <div className="h-full flex items-center"><span className="material-symbols-outlined text-xl xl:scale-[1.1667]">dropper_eye</span></div>
                                            Kills: <span className="text-[#CC9614] font-['Madimi_One'] mt-[2px]">{userData['total_kills']}</span>
                                        </li>

                                        <li className="flex items-center flex-row gap-3">
                                            <div className="h-full flex items-center"><span className="material-symbols-outlined text-xl xl:scale-[1.1667]">skull</span></div>
                                            Deaths: <span className="text-[#CC9614] font-['Madimi_One'] mt-[2px]">{userData['total_deaths']}</span>
                                        </li>

                                        <li className="flex items-center flex-row gap-3">
                                            <div className="h-full flex items-center"><span className="material-symbols-outlined text-xl xl:scale-[1.1667]">point_scan</span></div>
                                            Damage dealt: <span className="text-[#CC9614] font-['Madimi_One'] mt-[2px]">{userData['total_damage_done']}</span>
                                        </li>

                                        <li className="flex items-center flex-row gap-3">
                                            <div className="h-full flex items-center"><span className="material-symbols-outlined text-xl xl:scale-[1.1667]">social_leaderboard</span></div>
                                            MVPs: <span className="text-[#CC9614] font-['Madimi_One'] mt-[2px]">{userData['total_mvps']}</span>
                                        </li>

                                        <li className="flex items-center flex-row gap-3">
                                            <div className="h-full flex items-center"><span className="material-symbols-outlined text-xl xl:scale-[1.1667]">alarm</span></div>
                                            Time played: <span className="text-[#CC9614] font-['Madimi_One'] mt-[2px]">{Math.floor(userData['total_time_played'] / 60 / 60)} h</span>
                                        </li>

                                        <li className="flex items-center flex-row gap-3">
                                            <div className="h-full flex items-center"><span className="material-symbols-outlined text-xl xl:scale-[1.1667]">bomb</span></div>
                                            Planted bombs: <span className="text-[#CC9614] font-['Madimi_One'] mt-[2px]">{userData['total_planted_bombs']}</span>
                                        </li>

                                        <li className="flex items-center flex-row gap-3">
                                            <div className="h-full flex items-center"><span className="material-symbols-outlined text-xl xl:scale-[1.1667]">tools_pliers_wire_stripper</span></div>
                                ...
                                <div className="flex flex-col bg-white w-full flex-1 max-w-[400px] xl:min-w-[328px] xl:max-w-[400px] lg:h-[388px] px-6 py-4 lg:p-6 gap-3 lg:gap-4 rounded-3xl border-b-4 border-r-4 border-t-[1px] border-l-[1px]">
                                    ...
                                    <ol className="flex flex-col gap-3 lg:gap-4 text-base xl:text-xl font-medium">
                                        ...
                                        <li className="flex items-center flex-row gap-3">
                                            <div className="h-full flex items-center"><span className="material-symbols-outlined xl:scale-[1.1667]">visibility_off</span></div>
                                            Blinded enemy killed: <span className="text-[#CC9614] font-['Madimi_One'] mt-[2px]">{userData['total_kills_enemy_blinded']}</span>
                                        </li>

                                        <li className="flex items-center flex-row gap-3">
                                            <div className="h-full flex items-center"><span className="material-symbols-outlined xl:scale-[1.1667]">cognition_2</span></div>
                                            Headshot kills: <span className="text-[#CC9614] font-['Madimi_One'] mt-[2px]">{userData['total_kills_headshot']}</span>
                                        </li>

                                        <li className="flex items-center flex-row gap-3">
                                            <div className="h-full flex items-center"><span className="material-symbols-outlined xl:scale-[1.1667]">border_all</span></div>
                                            Broken windows: <span className="text-[#CC9614] font-['Madimi_One'] mt-[2px]">{userData['total_broken_windows']}</span>
                                        </li>

                                        <li className="flex items-center flex-row gap-3">
                                            <div className="h-full flex items-center"><span className="material-symbols-outlined xl:scale-[1.1667]">sword_rose</span></div>
                                            <p className="max-w-[148px] xl:max-w-[200px]">Kills using enemies weapon:</p> <span className="flex items-center h-full text-[#CC9614] font-['Madimi_One'] mt-[2px]">{userData['total_kills_enemy_weapon']}</span>
                                        </li>                               
                                    </ol>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-6 md:gap-4 xl:gap-6 w-full items-center xl:items-start xl:max-w-[800px] h-full">
                                <div className="flex flex-row sm:gap-3 lg:gap-2 xl:gap-3 overflow-clip overflow-x-auto bg-white w-full h-[252px] max-w-[400px] md:max-w-full md:h-fit lg:w-full lg:max-w-full lg:min-w-[550px] p-4 xl:py-4 rounded-3xl border-black 
                                border-t-[1px] border-r-4 border-b-4 border-l-[1px]">

                                    <div className="flex flex-col gap-2 xl:gap-4 w-full h-full items-center">
                                        <h1 className="text-base xl:text-xl font-['Madimi_One'] text-black">Win Rate:</h1>
                                    ...
                                    <div className="flex flex-col gap-2 xl:gap-4 w-full h-full items-center">
                                        <h1 className="text-base xl:text-xl font-['Madimi_One'] text-black">Hitted shots:</h1>
                                        <div className="w-[180px] h-[180px] md:w-full">
                                    ...
                                    <div className="flex flex-col gap-2 xl:gap-4 w-full h-full items-center">
                                        <h1 className="text-base xl:text-xl font-['Madimi_One'] text-black">Headshot Kill:</h1>
                                        <div className="w-[180px] h-[180px] md:w-full">
                                ...
                                <div className={`relative flex flex-col bg-white w-full max-w-[400px] lg:w-full ${isExpanded2 ? 'h-[672px] max-h-[672px]' : 'h-[264px] max-h-[264px]'} md:w-full md:max-w-full md:h-fit md:max-h-full xl:h-[510px] xl:max-h-[510px] xl:max-w-[900px] rounded-3xl border-black border-t-[1px] border-r-4 border-b-4 border-l-[1px] px-6 py-4 lg:p-6 gap-3 lg:gap-4`}>
                                    <h1 className="w-full text-center text-base xl:text-xl font-['Angkor'] text-[#CC9614]">Last match stats: </h1>
                                    <div className={`flex flex-col md:flex-row xl:px-2 2xl:px-10 ${isExpanded2 ? 'h-[564px] max-h-[564px]' : 'max-h-[156px]'} md:h-full md:max-h-full items-center overflow-clip`}>
                                        <ol className={`flex flex-col gap-3 xl:gap-4 text-base xl:text-xl font-medium w-full overflow-clip`}>
                                            <li className="flex items-center flex-row gap-3">
                                                <div className="h-full flex items-center"><span className="material-symbols-outlined text-xl xl:scale-[1.1667]">dropper_eye</span></div>
                                                Kills: <span className="text-[#CC9614] font-['Madimi_One'] mt-[2px]">{userData['last_match_kills']}</span>
                                            </li>
                                            <li className="flex items-center flex-row gap-3">
                                                <div className="h-full flex items-center"><span className="material-symbols-outlined text-xl xl:scale-[1.1667]">payments</span></div>
                                                Money spent: <span className="text-[#CC9614] font-['Madimi_One'] mt-[2px]">{userData['last_match_money_spent']} $</span>
                                            </li>
                                            <li className="flex items-center flex-row gap-3">
                                                <div className="h-full flex items-center"><span className="material-symbols-outlined text-xl xl:scale-[1.1667]">crown</span></div>
                                            ...
                                            <li className="flex items-center flex-row gap-3">
                                                <div className="h-full flex items-center"><span className="material-symbols-outlined text-xl xl:scale-[1.1667]">humidity_low</span></div>
                                                Dealt damage: <span className="text-[#CC9614] font-['Madimi_One'] mt-[2px]">{userData['last_match_damage']}</span>
                                            </li>
                                            <li className="flex items-center flex-row gap-3">
                                                <div className="h-full flex items-center"><span className="material-symbols-outlined text-xl xl:scale-[1.1667]">swords</span></div>
                                                Favorite weapon: <span className="text-[#CC9614] font-['Madimi_One'] mt-[2px]">{nameOfTheWeapon}</span>
                                            </li>
                                            <li className="flex items-center flex-row gap-3">
                                                <div className="h-full flex items-center"><span className="material-symbols-outlined text-xl xl:scale-[1.1667]">arrow_forward</span></div>
                                        ...
                                        <div className="flex flex-col gap-2 lg:gap-4 w-full mt-4 xl:mt-0 h-full justify-center items-center">
                                            <h1 className="text-base xl:text-xl font-['Madimi_One'] text-black">Better Side:</h1>
