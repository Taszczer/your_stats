...
export default function GunStats(data: GunData) {
  ...
  const [selectedCategory, setSelectedCategory] =
    useState<keyof typeof gunInfo.guns>("pistols");
      ...
      <div className="flex flex-col w-full max-w-[400px] md:max-w-full lg:max-w-[1234px] bg-white border-t-[1px] border-r-4 border-b-4 border-l-[1px] rounded-3xl gap-3 xl:gap-4 px-6 py-4 xl:p-6 mb-8">
        ...
        <div className="flex flex-row gap-3 xl:gap-4 items-center flex-wrap">
          ...
          >
            {guns === gunInfo.guns.pistols ? (
              <h1 className="text-xl xl:text-2xl font-semibold underline text-[#CC9614]">
                Pistols
              </h1>
            ) : (
              <h1 className="text-base xl:text-xl font-semibold text-black">
                Pistols
              </h1>
            )}
          </div>
        ...
        <div className="flex flex-wrap flex-row justify-center w-full">
          {Object.values(guns).map((gun, key) => (
            <div
              key={key}
              className="ml-2 mr-2 lg:ml-5 xl:ml-7 lg:mr-0 mt-3 xl:mt-4 flex flex-col items-center px-3 py-6 gap-3 bg-[#FFF1E6] rounded-3xl border-r-4 border-b-4 border-[1px] w-fit xl:min-w-[178px] xl:w-[178px] border-black"
            >
              <h1 className="text-base xl:text-xl font-['Madimi_One']">
                {gun.name}
              </h1>
              ...
              <p className="text-base xl:text-xl font-medium">
                Kills:{" "}
                <span className="font-['Madimi_One'] text-[#CC9614]">
                  {gun.kills}
                </span>
              </p>
            </div>
