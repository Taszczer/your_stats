...
export default function Home() {
  return (
    <>
      <div className="w-full max-w-screen mt-[100px] lg:mt-[200px] text-center">
        <h1 className="font-dynamo text-8xl md:text-[196px] lg:text-[256px] tracking-widest leading-[100px]">
          YOUR
        </h1>
        <h3 className="font-dynamo text-[64px] md:text-9xl lg:text-[156px] mt-[-32px] md:mt-4 lg:mt-10">
          STATS
        </h3>
      </div>
